            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Chapters {{ $chapter->name }}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" method="post" action="{{route('chapters.update', $chapter->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label>Story</label>
                                        <div>
                                            <select class="form-control" name="story_id" id="storyName" disabled>
                                    ...
                                    <div class="form-group">
                                        <label>Name</label>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="name" value="{{ $chapter->name }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Content</label>
                                        <textarea name="content" class="form-control" id="edit_content_ckeditor" disabled placeholder="content" value="{{ old('content',isset($chapter->content)? $chapter->content :'') }}">{{ $chapter->content ?? '' }}</textarea>
                                    </div>
