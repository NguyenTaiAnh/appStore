            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Create Chapters</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="wrapper-md">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                @endif
                                <form role="form" method="post" action="{{route('chapters.store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label>Content</label>
                                        <textarea name="content" class="form-control" id="content-ckeditor" placeholder="content" value="{{ old('content') }}">{{ old('content') }}</textarea>
                                    </div>
